...
public class SearchSenState extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_sen_state);
        Button zipButton = (Button) findViewById(R.id.button3);
        zipButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText zipEdit = (EditText) findViewById(R.id.editText2);
                ...
                toast.show();
                Zip = "http://whoismyrepresentative.com/getall_sens_bystate.php?state=" + zipEnter + "&output=json";
                switch (v.getId()) {
                    case R.id.button3:
    ...
    public class XMLParser extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            TextView zipText = (TextView) findViewById(R.id.textView3);
            try {
